                  ...
                  <tr>
                    <td class="p-4">
                      <div class="media align-items-center">
                        <img src="<?= $row->image ? base_url("images/product/$row->image") : base_url('images/product/default.png') ?>" class="d-block ui-w-40 ui-bordered mr-4" alt="" height="50"> <strong><?= $row->title ?></strong>
                      </div>
                    </td>
                    <td class="text-right font-weight-semibold align-middle p-4"> Rp.<?= number_format($row->price, 0, ',', '.') ?>,- </td>
                    ...
                    <td class="text-right font-weight-semibold align-middle p-4">Rp.<?= number_format($row->subtotal, 0, ',', '.') ?>,-</td>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
              ...
              <div class="d-flex">
                <div class="text-right mt-4 mr-5">
                  ...
                  <div class="text-large"><strong>Rp.0,-</strong></div>
                </div>
                <div class="text-right mt-4">
                  <label class="text-muted font-weight-normal m-0">Total price</label>
                  <div class="text-large"><strong>Rp.<?= number_format(array_sum(array_column($content, 'subtotal')), 0, ',', '.') ?>,-</strong></div>
                </div>
              </div>
            </div>
        
            <div class="float-right">
              <a href="<?=base_url('home') ?>" class="btn btn-lg btn-default md-btn-flat mt-2 mr-3">Back to shopping</a>
              <a href="<?= base_url('checkout') ?>" class="btn btn-lg btn-success mt-2">Checkout</a>
            </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="">
              <div class="list-space">
                <img src="assets/logo/dli-store.png"
                  height="35px"
                  alt="" />
              </div>
              <nav class="list-unstyled">
                ...
                <li class="list-space">
                  <a href="<?= base_url() ?>home" class="list-menu">Produk</a>
                </li>
                <li class="list-space">
                  <a href="<?= base_url() ?>#mitra" class="list-menu">Mitra</a>
                </li>
                <li class="list-space">
                  <a href="#tentang" class="list-menu">Tentang</a>
                </li>
              </nav>
            </div>
          </div>
