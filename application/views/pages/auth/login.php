        ...
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
          ...
          <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
            <div class="right mx-lg-0 mx-auto">
              ...
              <h3 class="title-text">Masuk untuk lanjut</h3>
              <p class="caption-text">
                Mohon masuk dengan akun yang<br />
              ...
              <?= form_open('login', ['method' => 'POST']) ?>
                <div style="margin-bottom: 1.75rem">
                  ...
                  <div class="d-flex w-100 div-input">
                    ...
                    <?= form_input(['type' => 'email', 'name' => 'email', 'value' => $input->email, 'class' => 'input-field border-0', 'placeholder' => 'Masukan email', 'required' => true, 'autocomplete' => 'on']) ?>
                            <?= form_error('email') ?>
                  </div>
                </div>
                <div style="margin-top: 1rem">
                  ...
                  <div class="d-flex w-100 div-input">
                    ...
                    <?= form_password('password', '', ['class' => 'input-field border-0', 'placeholder' => 'Masukkan password', 'required' => true]) ?>
                            <?= form_error('password') ?>
              ...
              <p class="text-center bottom-caption">
                Belum memiliki akun?
                <a href="<?= base_url('register') ?>" class="green-bottom-caption">Daftar Disini</a>
              </p>
            </div>
          </div>
        </div>
