 <section class="h-100 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
        <style>
          ...
          .content-4-1 .btn-fill:hover {
            background-image: linear-gradient(#27c499, #27c499);
            transition: 0.5s;
          }
        ...
        <div class="content-4-1 d-flex flex-column align-items-center h-100 flex-lg-row"
          ...
          <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
            <div class="right mx-lg-0 mx-auto">
              ...
              <h3 class="title-text">Daftar Akun</h3>
              <p class="caption-text">
                Silakan isi data diri dibawah <br />
                untuk membuat akun website.
              </p>
              <?= form_open('register', ['method' => 'POST']) ?>
                <div style="margin-bottom: 1.75rem">
                  ...
                  <div class="d-flex w-100 div-input">
                    ...
                    <?= form_input('name', $input->name, ['class' => 'input-field border-0', 'required' => true, 'autofocus' => true, 'placeholder' => 'Masukkan Nama Lengkap', 'autocomplete' => 'on']) ?>
                    <?= form_error('name') ?>
                  </div>
                </div>
                <div style="margin-bottom: 1.75rem">
                  ...
                  <div class="d-flex w-100 div-input">
                    ...
                    <?= form_input(['type' => 'email', 'name' => 'email', 'value' => $input->email, 'class' => 'input-field border-0', 'placeholder' => 'Masukan alamat email aktif', 'required' => true, 'autocomplete' => 'on']) ?>
                    <?= form_error('email') ?>
                  </div>
                </div>
                <div style="margin-top: 1rem">
                  ...
                  <div class="d-flex w-100 div-input">
                    ...
                    <?= form_password('password', '', ['class' => 'input-field border-0', 'placeholder' => 'Password minimal 8 karakter', 'required' => true]) ?>
                    <?= form_error('password') ?>
                ...
                <div style="margin-top: 1rem">
                  ...
                  <div class="d-flex w-100 div-input">
                    ...
                    <?= form_password('password_confirmation', '', ['class' => 'input-field border-0', 'placeholder' => 'Masukkan password yang sama', 'required' => true]) ?>
              ...
              <p class="text-center bottom-caption">
                Sudah memiliki akun?
                <a href="<?= base_url('login') ?>" class="green-bottom-caption">Masuk Disini</a>
              </p>
            </div>
          </div>
        </div>
