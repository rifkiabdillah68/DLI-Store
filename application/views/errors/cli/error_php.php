<!DOCTYPE html>
  <html lang="en">
    ...
    <div class="empty-2-2 container mx-auto d-flex align-items-center justify-content-center flex-column" style="font-family: 'Poppins', sans-serif;">    
        <img class="logo" src="assets/logo/dli-store.png" alt="" height="50px">
        ...
        <div class="text-center w-100">
            <h1 class="title-text">
                Opss! Terdapat Kesalahan
            </h1>
            <p class="title-caption">
                Halaman Tidak Ditemukan. Kami<br class="d-sm-block d-none"> menyarankan anda kembali ke halaman utama.
            </p>
